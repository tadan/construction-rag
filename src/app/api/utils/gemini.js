...
const GEMINI_API_ENDPOINT = 'https://generativelanguage.googleapis.com/v1/models/gemini-2.0-flash:streamGenerateContent';
...
function convertToGeminiFormat(messages) {
  ...
  // If we have system messages, add them as first user message
